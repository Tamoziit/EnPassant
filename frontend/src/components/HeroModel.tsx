        ...
        <div className="w-full h-[500px] md:h-[620px] lg:h-[700px] mx-auto relative bg-gradient-to-br from-slate-900 to-blue-900 rounded-2xl overflow-hidden shadow-2xl border border-blue-800/30">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-t from-slate-900/20 to-transparent pointer-events-none">
                <div className="text-center space-y-2">
                    <h2 className="text-4xl lg:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-200 via-slate-300 to-slate-400/80 tracking-wide">
                        Welcome to EnPassant
                    </h2>
                    <p className="text-blue-300/80 text-base lg:text-xl">Venture into an emersing journey of 64 Squares...</p>
                </div>
